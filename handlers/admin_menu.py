...
from handlers.delete_hosting import get_delete_hosting_handler
...
async def admin_menu_callback(update, context):
    ...
    if query.data == "admin_addhosting":
        ...
        # Cukup biarkan kosong di sini,
        # karena conversation handler delete hosting sudah didaftarkan terpisah
        return
...
def get_admin_menu_handler():
    return [
        ...
        get_delete_hosting_handler(),  # Tambahkan di sini ConversationHandler delete hosting
    ]
